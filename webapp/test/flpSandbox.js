		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vendor Page",
									"targetURL": "#comappvendorpageforrequest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappvendorpageforrequest-display": {
								"semanticObject": "comappvendorpageforrequest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.vendorpageforrequest",
									"url": sap.ui.require.toUrl("com/app/vendorpageforrequest")
								}
							}
						}
					}
